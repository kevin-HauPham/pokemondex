...
export const DetailPage = () => {
  ...
  // Fetch the full Redux state
  const fullState = useSelector((state) => state.pokemons);
  ...
  const { pokemon, nextPokemon, previousPokemon } = useSelector(
    (state) => state.pokemons.pokemon || {} // Ensure default empty object to avoid destructuring issues
  );
